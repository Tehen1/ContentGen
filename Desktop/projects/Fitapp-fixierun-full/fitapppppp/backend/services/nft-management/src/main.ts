...
async function bootstrap() {
  ...
  if (environment !== 'production') {
    const config = new DocumentBuilder()
      .setTitle('FIXIE NFT Management Service API')
      .setDescription('API documentation for the FIXIE NFT management microservice')
      .setVersion('1.0')
      .addTag('nft')
      .addBearerAuth()
      .build();
  ...
  logger.log(`NFT Management microservice running on port ${port} in ${environment} mode`);
