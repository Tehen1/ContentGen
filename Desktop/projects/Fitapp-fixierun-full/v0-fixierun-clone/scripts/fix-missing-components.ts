...
function installFramerMotion() {
  try {
    // Check if framer-motion is already installed
    execSync("npm list framer-motion", { stdio: "ignore" })
...
// Main function to fix missing components and dependencies
async function fixMissingComponentsAndDependencies() {
  ...
  console.log("Completed fixing missing components and dependencies")
}

// Run the function
fixMissingComponentsAndDependencies().catch(console.error)
